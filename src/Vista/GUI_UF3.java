...
public class GUI_UF3 {
     ...
     * pilots
     */
    public static Object[][] transformaDades(PersonatgesWow[] dades) {
        ...
        for (int i = 0; i < dades.length; i++) {
            if (dades[i].isOmplit()) {
                ...
                resultat[omplits][2] = dades[i].getNivell();
                resultat[omplits][3] = dades[i].getRaça();
                resultat[omplits][4] = dades[i].isEsHorda();
                omplits++;
            }
        }
...
//        if (dorsal < 0) {
//            System.out.println("El dorsal ha de ser positiu o zero!!");
//        } else {
//            this.dorsal = dorsal;
//        }
//    }
...
//        if (dinersGuanyats < 0) {
//            System.out.println("Els diners no poden ser negatius!!");
//        } else {
//            this.dinersGuanyats = dinersGuanyats;
//        }
//    }
